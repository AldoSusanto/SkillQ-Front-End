        ...
        return(
            <div className="quiz-container">
                ...
                <div className="choices-container">
                    <p onClick={this.userAnswered} className="choice">{currQuestion.question.optionA}</p>
                    <p onClick={this.userAnswered} className="choice">{currQuestion.question.optionB}</p>
                </div>
                <div className="choices-container">
                    <p onClick={this.userAnswered} className="choice">{currQuestion.question.optionC}</p>
                    <p onClick={this.userAnswered} className="choice">{currQuestion.question.optionD}</p>
                </div>
